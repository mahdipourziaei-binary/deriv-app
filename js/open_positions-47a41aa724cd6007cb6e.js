        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = OpenPositions.__proto__ || Object.getPrototypeOf(OpenPositions)).call.apply(_ref, [this].concat(args))), _this), _this.getRowAction = function (row_obj) {
            return row_obj.is_unsupported ? {
                component: _react2.default.createElement(_localize2.default, {
                    ...
                    components: [_react2.default.createElement('a', { key: 0, className: 'link link--orange', rel: 'noopener noreferrer', target: '_blank', href: (0, _url.urlFor)('user/portfoliows', undefined, undefined, true) })]
                })
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_reportsMeta.ReportsMeta, {
                    i18n_heading: (0, _i18n.localize)('Open positions'),
                    i18n_message: (0, _i18n.localize)('View all active trades on your account that can still incur a profit or a loss.')
                }),
                is_loading && active_positions.length === 0 || is_empty ? _react2.default.createElement(_placeholderComponent2.default, {
                    ...
                    localized_message: (0, _i18n.localize)('You have no open positions yet.')
