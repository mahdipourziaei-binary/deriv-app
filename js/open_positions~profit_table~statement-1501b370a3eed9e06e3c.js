...
var getStatementTableColumnsTemplate = exports.getStatementTableColumnsTemplate = function getStatementTableColumnsTemplate(currency) {
    return [{
        ...
        title: (0, _i18n.localize)('Ref. ID'),
        col_index: 'refid'
    }, {
        title: (0, _i18n.localize)('Transaction time'),
        col_index: 'date'
    }, {
        key: 'mode',
        title: (0, _i18n.localize)('Transaction'),
        col_index: 'action_type',
        ...
        title: (0, _i18n.localize)('Credit/Debit'),
        col_index: 'amount',
        ...
        title: (0, _i18n.localize)('Balance'),
        col_index: 'balance',
...
var getProfitTableColumnsTemplate = exports.getProfitTableColumnsTemplate = function getProfitTableColumnsTemplate(currency) {
    return [{
        ...
        renderCellContent: function renderCellContent(_ref5) {
            ...
            if (is_footer) return (0, _i18n.localize)('Total profit/loss');
        ...
        title: (0, _i18n.localize)('Buy time'),
        col_index: 'purchase_time'
    }, {
        title: (0, _i18n.localize)('Buy price'),
        col_index: 'buy_price',
        ...
        title: (0, _i18n.localize)('Sell time'),
        col_index: 'sell_time'
    }, {
        title: (0, _i18n.localize)('Sell price'),
        ...
        title: (0, _i18n.localize)('Profit/Loss'),
...
var getOpenPositionsColumnsTemplate = exports.getOpenPositionsColumnsTemplate = function getOpenPositionsColumnsTemplate(currency) {
    return [{
        ...
        renderCellContent: function renderCellContent(_ref9) {
            ...
            if (is_footer) return (0, _i18n.localize)('Total');
        ...
        title: (0, _i18n.localize)('Potential payout'),
        col_index: 'payout',
        ...
        title: (0, _i18n.localize)('Indicative price'),
        ...
        title: (0, _i18n.localize)('Remaining time'),
        col_index: 'id',
