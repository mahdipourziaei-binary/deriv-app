...
var getTableColumnsTemplate = exports.getTableColumnsTemplate = function getTableColumnsTemplate(currency) {
    return [{
        title: (0, _i18n.localize)('Reference No.'),
        col_index: 'reference',
        renderCellContent: function renderCellContent(_ref) {
            var cell_value = _ref.cell_value,
                is_footer = _ref.is_footer;
            return is_footer ? (0, _i18n.localize)('Total') : cell_value;
        }
    }, {
        title: (0, _i18n.localize)('Contract Type'),
        col_index: 'type',
        ...
        title: (0, _i18n.localize)('Contract Details'),
        col_index: 'details'
    }, {
        ...
        title: (0, _i18n.localize)('Purchase'),
        col_index: 'purchase',
        ...
        title: (0, _i18n.localize)('Indicative'),
