...
var Page404 = function Page404() {
    return _react2.default.createElement(_PageError2.default, {
        header: (0, _i18n.localize)('Oops, page not available.'),
        error_code: 404,
        messages: [(0, _i18n.localize)('The page you requested could not be found. Either it no longer exists or the address is wrong. Please check for any typos.')],
        redirect_url: _Constants.routes.trade,
        redirect_label: (0, _i18n.localize)('Return to Trade')
    });
};
